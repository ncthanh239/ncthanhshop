    ...
    $.ajax({
      ...
      success: function(response){
        ...
        $.each(response.image,function(key, value){
          ...
          // var url11 = '{{asset(\Storage::url('urla'))}}';
          // var url11 = 'asset('storage/images/') . $image';
          ...
          var html='<div class="item " ><img class="anha"   src="" style="max-width:100%;height:400px"></div>';
          

          // var html = '<div class="item " ><img   src="'.$url.'" style="max-width:100%;height:400px"></div>';
